            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <h1
                        ...
                        Masuk ke Akun yang kamu miliki
                    </h1>
                    <form action="{{ route('auth.authenticate') }}" method="POST" class="space-y-4 md:space-y-6">
                        @csrf
                        <div>
                            <label for="email"
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                    <label for="remember" class="text-gray-500 dark:text-gray-300">Ingat Akun ini</label>
                                </div>
                            </div>
                            {{-- <a href="#"
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Belum mempunyai Akun? <a href="{{route('auth.register')}}"
                                class="font-medium text-primary-600 hover:underline dark:text-primary-500">Daftar Akun</a>
                        </p>
                    </form>
                </div>
            </div>
